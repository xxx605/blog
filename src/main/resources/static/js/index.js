$(function () {
    $(document).on("click",".atitle",function () {
       var id =$(this).parents(".article").prop("id");
        id=encrypt(id);
        document.write("<form action=detail method=post name=aid style='display:none'>");
        document.write("<input type=hidden name=aid value='"+id+"'/>");
        document.write("</form>");
        document.aid.submit();
    })
    ...
    $("#categorylist a").click(function () {
        ...
        location.href="article?classify="+classify
    })
