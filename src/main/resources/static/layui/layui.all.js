...
layui.define("jquery", function (e) {
    ...
    D.prototype.config = {
        ...
        i(c)[0] && i(c).data("templates.index") == e.index ? e.removePicker(D.thisElemInd) : (e.removePicker(D.thisElemInd), i("body").append(t)), D.thisElemInd = e.index, D.thisColor = r.style.background, e.position(), e.pickerEvents()
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    F.prototype.config = {
        ...
        var v = function (e) {
            var l = t(this), n = l.parents("tr").eq(0).data("templates.index"),
        ...
        a.elem.on("click", 'input[name="layTableCheckbox"]+', function () {
            ...
            var e = t(this).prev(), i = e[0].checked, l = d.cache[a.key],
                n = e.parents("tr").eq(0).data("templates.index");
        ...
        a.layBody.on("click", "." + g, function (e) {
            ...
            var e = t(this), i = e.parents("tr").eq(0).data("templates.index");
